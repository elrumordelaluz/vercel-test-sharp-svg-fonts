  ...
  try {
    ...
    const mainText = Buffer.from(
      `<svg width="500" height="200">
          <text x="0" y="0" font-family="'sans-serif'" font-size="48" font-weight="bold" letter-spacing="-0.7">
    ...
    const smallText = Buffer.from(
      `<svg width="870" height="50">
          <text x="50%" dominant-baseline="middle" text-anchor="middle" y="22" font-family="'sans-serif'" font-size="22" font-weight="bold" fill="#2c2d2c" letter-spacing=".8">
            Hello World.
          </text>
        </svg>`
    )
